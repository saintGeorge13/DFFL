...
def get_agent_loader(args, kwargs):
    ...
    if not args.test_only:
        ...
        train_dataset = datasets.FashionMNIST(args.dir_data, train=True, transform=transform_train, download=True)
    ...
    for i in range(args.n_agents):
        ...
        # train_dl = DataLoader(dataset=train_ds, batch_size=args.batch_size, shuffle=True, worker_init_fn=seed_worker,generator=g)
