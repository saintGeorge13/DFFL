...
parser.add_argument('--skewed', type=int, nargs='?', default=1,
                        help='''default [0.1, 0.1, 0.1, 0.1, 0.6] for "0.0625,0.125,0.25,0.5,1.0 
                        default [0.1, 0.1, 0.1, 0.7] for "0.25,0.5,0.75,1.0''')
parser.add_argument('--fair', type=int, nargs='?', default=1,
                        help='fairness select client or not')
